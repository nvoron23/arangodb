...
void TRI_InitialiseErrorMessages () {
  ...
  REG_ERROR(ERROR_ARANGO_TRIGGER_NOT_FOUND, "trigger not found");
  REG_ERROR(ERROR_ARANGO_TRIGGER_EXISTS, "trigger already exists");
  REG_ERROR(ERROR_ARANGO_TRIGGER_HANDLE_BAD, "illegal trigger handle");
  REG_ERROR(ERROR_ARANGO_TRIGGER_FUNCTION_INVALID_CODE, "invalid trigger function code");
  REG_ERROR(ERROR_ARANGO_TRIGGER_RUNTIME_ERROR, "trigger function runtime error: %s");
