...
static void ExecuteSkiplistQuery (const v8::FunctionCallbackInfo<v8::Value>& args,
  ...
  if (args.Length() < 2) {
    TRI_V8_EXCEPTION_USAGE(signature.c_str());
  }
  ...
  if (skiplistOperator == nullptr) {
    TRI_V8_EXCEPTION(TRI_ERROR_BAD_PARAMETER);
  }
...
static void EdgesQuery (TRI_edge_direction_e direction,
  ...
  if (args.Length() != 1) {
    switch (direction) {
      case TRI_EDGE_IN:
        TRI_V8_EXCEPTION_USAGE("inEdges(<vertices>)");

      case TRI_EDGE_OUT:
        TRI_V8_EXCEPTION_USAGE("outEdges(<vertices>)");

      case TRI_EDGE_ANY:
      default: {
        TRI_V8_EXCEPTION_USAGE("edges(<vertices>)");
      }
    }
  }
...
static void JS_AllQuery (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  if (args.Length() != 2) {
    TRI_V8_EXCEPTION_USAGE("ALL(<skip>, <limit>)");
  }
...
static void JS_NthQuery (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  if (args.Length() != 2 || ! args[0]->IsNumber() || ! args[1]->IsNumber()) {
    TRI_V8_EXCEPTION_USAGE("NTH(<partitionId>, <numberOfPartitions>)");
  }
...
static void JS_Nth2Query (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  // expecting two arguments
  if (args.Length() != 2 || ! args[0]->IsNumber() || ! args[1]->IsNumber()) {
    TRI_V8_EXCEPTION_USAGE("NTH2(<partitionId>, <numberOfPartitions>)");
  }
...
static void JS_Nth3Query (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  if (args.Length() != 2 || ! args[0]->IsString() || ! args[1]->IsNumber()) {
    TRI_V8_EXCEPTION_USAGE("NTH3(<key>, <numberOfPartitions>)");
  }
...
static void JS_OffsetQuery (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  // expecting two arguments
  if (args.Length() != 4) {
    TRI_V8_EXCEPTION_USAGE("OFFSET(<internalSkip>, <batchSize>, <skip>, <limit>)");
  }
...
static void JS_ByExampleQuery (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  if (args.Length() < 1) {
    TRI_V8_EXCEPTION_USAGE("BY_EXAMPLE(<example>, <skip>, <limit>)");
  }
...
static void ByExampleHashIndexQuery (SingleCollectionReadOnlyTransaction& trx,
  ...
  // expecting index, example, skip, and limit
  if (args.Length() < 2) {
    TRI_V8_EXCEPTION_USAGE("EXAMPLE_HASH(<index>, <example>, <skip>, <limit>)");
  }
...
static void JS_FirstQuery (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  if (args.Length() > 1) {
    TRI_V8_EXCEPTION_USAGE("FIRST(<count>)");
  }
...
static void FulltextQuery (SingleCollectionReadOnlyTransaction& trx,
  ...
  if (args.Length() != 2) {
    TRI_V8_EXCEPTION_USAGE("FULLTEXT(<index-handle>, <query>)");
  }
...
static void JS_LastQuery (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  if (args.Length() > 1) {
    TRI_V8_EXCEPTION_USAGE("LAST(<count>)");
  }
...
static void NearQuery (SingleCollectionReadOnlyTransaction& trx,
  ...
  if (args.Length() != 4) {
    TRI_V8_EXCEPTION_USAGE("NEAR(<index-handle>, <latitude>, <longitude>, <limit>)");
  }
...
static void WithinQuery (SingleCollectionReadOnlyTransaction& trx,
  ...
  if (args.Length() != 4) {
    TRI_V8_EXCEPTION_USAGE("WITHIN(<index-handle>, <latitude>, <longitude>, <radius>)");
  }
