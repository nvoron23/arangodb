...
static void DocumentVocbaseColCoordinator (TRI_vocbase_col_t const* collection,
  ...
  if (responseCode >= triagens::rest::HttpResponse::BAD) {
    ...
    if (generateDocument) {
      ...
      TRI_V8_EXCEPTION_MESSAGE(errorNum, errorMessage);
    }
    else {
      TRI_V8_RETURN_FALSE();
    }
...
static void DocumentVocbaseCol (bool useCollection,
  ...
  if (args.Length() != 1) {
    TRI_V8_EXCEPTION_USAGE("document(<document-handle>)");
  }
  ...
  if (rid != 0 && document._rid != rid) {
    TRI_V8_EXCEPTION_MESSAGE(TRI_ERROR_ARANGO_CONFLICT, "revision not found");
  }
...
static void ExistsVocbaseCol (bool useCollection,
  ...
  // first and only argument should be a document idenfifier
  if (args.Length() != 1) {
    TRI_V8_EXCEPTION_USAGE("exists(<document-handle>)");
  }
...
void ReplaceVocbaseCol (bool useCollection,
  ...
  if (argLength < 2) {
    TRI_V8_EXCEPTION_USAGE("replace(<document>, <data>, {overwrite: booleanValue, waitForSync: booleanValue})");
  }
  ...
  if (ServerState::instance()->isDBserver()) {
    ...
    if (shardKeysChanged(col->_dbName, cidString, old, json, false)) {
      ...
      TRI_FreeJson(TRI_UNKNOWN_MEM_ZONE, json);
      TRI_V8_EXCEPTION(TRI_ERROR_CLUSTER_MUST_NOT_CHANGE_SHARDING_ATTRIBUTES);
    }
  ...
  if (shaped == nullptr) {
    TRI_V8_EXCEPTION_MESSAGE(TRI_errno(), "<data> cannot be converted into JSON shape");
  }
...
static void InsertVocbaseCol (TRI_vocbase_col_t* col,
  ...
  if (argLength < 1 || argLength > 2) {
    TRI_V8_EXCEPTION_USAGE("insert(<data>, [<waitForSync>])");
  }
...
static void UpdateVocbaseCol (bool useCollection,
  ...
  if (json == nullptr) {
    TRI_V8_EXCEPTION_MESSAGE(TRI_errno(), "<data> is no valid JSON");
  }
...
static void RemoveVocbaseCol (bool useCollection,
  ...
  if (argLength < 1 || argLength > 3) {
    TRI_V8_EXCEPTION_USAGE("remove(<document>, <options>)");
  }
...
static void JS_DropVocbaseCol (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  if (res != TRI_ERROR_NO_ERROR) {
    TRI_V8_EXCEPTION_MESSAGE(res, "cannot drop collection");
  }
      ...
      if (par->IsObject()) {
        ...
        if (po->Has(JournalSizeKey)) {
          ...
          if (info._maximalSize < TRI_JOURNAL_MINIMAL_SIZE) {
            ...
            TRI_V8_EXCEPTION_PARAMETER("<properties>.journalSize too small");
          }
        }
        ...
        if (po->Has(IsVolatileKey)) {
          if (TRI_ObjectToBoolean(po->Get(IsVolatileKey)) != info._isVolatile) {
            ...
            TRI_V8_EXCEPTION_PARAMETER("isVolatile option cannot be changed at runtime");
          }
        }
...
static void JS_RenameVocbaseCol (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  if (args.Length() < 1) {
    TRI_V8_EXCEPTION_USAGE("rename(<name>)");
  }

  if (ServerState::instance()->isCoordinator()) {
    // renaming a collection in a cluster is unsupported
    TRI_V8_EXCEPTION(TRI_ERROR_CLUSTER_UNSUPPORTED);
  }
  ...
  if (name.empty()) {
    TRI_V8_EXCEPTION_PARAMETER("<name> must be non-empty");
  }
  ...
  if (res != TRI_ERROR_NO_ERROR) {
    TRI_V8_EXCEPTION_MESSAGE(res, "cannot rename collection");
  }
...
static void JS_RotateVocbaseCol (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  TRI_SHARDING_COLLECTION_NOT_YET_IMPLEMENTED(collection);
  ...
  if (res != TRI_ERROR_NO_ERROR) {
    TRI_V8_EXCEPTION_MESSAGE(res, "could not rotate journal");
  }
...
static void InsertEdgeCol (TRI_vocbase_col_t* col,
  ...
  if (argLength < 3 || argLength > 4) {
    TRI_V8_EXCEPTION_USAGE("save(<from>, <to>, <data>, [<waitForSync>])");
  }
...
static void InsertEdgeColCoordinator (TRI_vocbase_col_t* collection,
  ...
  uint32_t const argLength = args.Length();
  if (argLength < 3 || argLength > 4) {
    TRI_V8_EXCEPTION_USAGE("insert(<from>, <to>, <data>, [<waitForSync>])");
  }
...
static void JS_TruncateDatafileVocbaseCol (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  if (args.Length() != 2) {
    TRI_V8_EXCEPTION_USAGE("truncateDatafile(<datafile>, <size>)");
  }
  ...
  if (collection->_status != TRI_VOC_COL_STATUS_UNLOADED &&
    ...
    TRI_READ_UNLOCK_STATUS_VOCBASE_COL(collection);
    TRI_V8_EXCEPTION(TRI_ERROR_ARANGO_COLLECTION_NOT_UNLOADED);
  }
  ...
  if (res != TRI_ERROR_NO_ERROR) {
    TRI_V8_EXCEPTION_MESSAGE(res, "cannot truncate datafile");
  }
...
static void JS_VersionVocbaseCol (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  if (res != TRI_ERROR_NO_ERROR) {
    TRI_V8_EXCEPTION_MESSAGE(res, "cannot fetch collection info");
  }
...
static void JS_ChangeOperationModeVocbase (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  if (args.Length() != 1) {
    TRI_V8_EXCEPTION_USAGE("_changeMode(<mode>), with modes: 'Normal', 'NoCreate'");
  }
  ...
  if (newModeStr == "NoCreate") {
    ...
    TRI_V8_EXCEPTION_USAGE("illegal mode, allowed modes are: 'Normal' and 'NoCreate'");
  }
...
static void JS_CollectionVocbase (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  // expecting one argument
  if (args.Length() != 1) {
    TRI_V8_EXCEPTION_USAGE("_collection(<name>|<identifier>)");
  }
...
static void JS_DatafileScanVocbaseCol (const v8::FunctionCallbackInfo<v8::Value>& args) {
  ...
  if (args.Length() != 1) {
    TRI_V8_EXCEPTION_USAGE("datafileScan(<path>)");
  }
