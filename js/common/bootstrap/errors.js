...
(function () {
  ...
  internal.errors = {
    ...
    "ERROR_ARANGO_TRIGGER_NOT_FOUND" : { "code" : 1237, "message" : "trigger not found" },
    "ERROR_ARANGO_TRIGGER_EXISTS"  : { "code" : 1238, "message" : "trigger already exists" },
    "ERROR_ARANGO_TRIGGER_HANDLE_BAD" : { "code" : 1239, "message" : "illegal trigger handle" },
    "ERROR_ARANGO_TRIGGER_FUNCTION_INVALID_CODE" : { "code" : 1240, "message" : "invalid trigger function code" },
    "ERROR_ARANGO_TRIGGER_RUNTIME_ERROR" : { "code" : 1241, "message" : "trigger function runtime error: %s" },
